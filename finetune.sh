...
export OUTPUT_DIR="./checkpoints/rdt-finetune-1b-dexmimicgen-boxcleanup"
export CFLAGS="-I/usr/include"
export LDFLAGS="-L/usr/lib/x86_64-linux-gnu"
export CUTLASS_PATH="/mnt/kyl/cutlass"
...
deepspeed --hostfile=hostfile.txt main.py \
    --deepspeed="./configs/zero2.json" \
    --pretrained_model_name_or_path="/mnt/kyl/models/rdt-1b/" \
